...
-- 별명이 공백을  포함하는 경우 큰따옴표 생략 불가능. 반드시 사용해야 함.
-- 별명에는 큰따옴표("")만 사용. 작은따옴표('')는 사용할 수 없음!
-- (주의) SQL에서 문자열을 사용하거나 비교할 때는 작은따옴표('')를 사용해야 함. (자바와 반대)
-- EX) 'SCOTT'
